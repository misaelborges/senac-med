...
public class BuscaMedicoAgendamento extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        tabelaMedico.setRowSelectionAllowed(false);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BuscaMedicoAgendamento.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
